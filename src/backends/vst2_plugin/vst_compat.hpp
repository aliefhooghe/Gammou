...
//  Taken from OSSIA/SCORE repo
//  https://github.com/OSSIA/score/blob/master/base/plugins/score-plugin-media/Media/Effect/VST/vst-compat.hpp
...
extern "C"
{
  ...
  struct HostCanDos
  {
    ...
    static const constexpr auto canDoSendVstMidiEventFlagIsRealtime = "sendVstMidiEventFlagIsRealtime";
